...
export function AppSidebar() {
  ...
  return (
    ...
    >
      <SidebarHeader className="h-16 flex items-center px-4 group-data-[collapsible=icon]:px-40!">
        ...
        <div className="mb-6 px-2">
          <Link href="/analyze">
            <Button className="w-full h-10 rounded-lg bg-primary hover:bg-primary/90 text-primary-foreground shadow-sm transition-all flex items-center justify-center gap-2 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-0">
              ...
              <span className="hidden lg:inline font-medium text-sm group-data-[collapsible=icon]:hidden">
                New Analysis
              </span>
            </Button>
          </Link>
                  ...
                  <SidebarMenuItem key={item.title}>
                    ...
                    >
                      <Link href={item.url} className="flex items-center gap-3">
                        ...
                        />
                        <span className="hidden lg:inline text-sm group-data-[collapsible=icon]:hidden">
                          {item.title}
                        </span>
                      </Link>
                    </SidebarMenuButton>
      ...
      <SidebarFooter className="p-4">
        <div className="flex items-center gap-3 overflow-hidden p-2 rounded-lg hover:bg-secondary/50 transition-colors cursor-pointer">
          ...
          <div className="flex flex-col lg:flex group-data-[collapsible=icon]:hidden">
